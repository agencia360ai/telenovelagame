...
### 7. Diagnose imbalance and cross-archetype friction
Ask:
...
### 8. Convert findings into design actions
...
- `references/bartle-notes.md` for a concise interpretation of the four archetypes in game-design terms
- `references/failure-patterns.md` for common archetype imbalance shapes
